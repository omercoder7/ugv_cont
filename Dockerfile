...
RUN echo "--> Building UGV workspace..." && \
    ...
    rosdep install -i --from-path src --rosdistro humble -y --skip-keys "roslaunch cmake_modules catkin gazebo python3-flask libg2o ros-humble-libg2o nav2-bringup ros-humble-nav2-bringup" && \
